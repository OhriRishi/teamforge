...
import { SheetFolder } from '@/types/sheets'
import { FolderPlus, Loader2 } from 'lucide-react'

interface SheetFolderDialogProps {
  folders: SheetFolder[]
...
export function SheetFolderDialog({ folders, onCreateFolder, onUpdateFolder, trigger, editFolder, open: controlledOpen, onOpenChange: controlledOnOpenChange }: SheetFolderDialogProps) {
  ...
  const getFlatFolders = (folders: SheetFolder[], level = 0): Array<{ folder: SheetFolder; level: number }> => {
    const result: Array<{ folder: SheetFolder; level: number }> = []
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            {editFolder ? 'Update folder name, color, or parent folder.' : 'Organize your sheets by creating folders and subfolders.'}
          </DialogDescription>
        </DialogHeader>
